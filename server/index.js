...
app.post('/api/admin/seed-default', async (req, res) => {
  try {
    const seedData = [
      { page: 'home', section: 'hero', data: { title: 'Premium Uniform Fabric for Every Industry', subtitle: 'High-quality, durable, and comfortable fabrics for schools, offices, hospitals, and industrial uniforms.', image: 'https://res.cloudinary.com/detwuzqry/image/upload/v1775717707/stitcheerr_assets/bsywtsz1pgrpqo3vcxhm.png' } },
      { page: 'home', section: 'features', data: { title: 'Fabric Solutions', subtitle: 'Industry Standards', items: [{ title: 'Corporate Shirting', description: 'Premium Toptex and Winnertex blends for executive professional wear.', image: 'https://res.cloudinary.com/detwuzqry/image/upload/v1775717711/stitcheerr_assets/xmcled7x5x7g8hlj0twj.png' }, { title: 'Industrial Safety', description: 'High-tensile strength blended fabrics for heavy-duty industrial environments.', image: 'https://res.cloudinary.com/detwuzqry/image/upload/v1775717713/stitcheerr_assets/x3ttybp68co4x43w6bgm.png' }, { title: 'Medical Scrubs', description: 'Antimicrobial and breathable fabrics for healthcare professionals.', image: 'https://res.cloudinary.com/detwuzqry/image/upload/v1775717712/stitcheerr_assets/rrqsqdcnsphsk63cb0fv.png' }] } },
    ...
    res.json({ message: 'Database seeded successfully from backend!' });
  } catch (error) {
