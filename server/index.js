  ...
  try {
    const seedData = [
      ...
      },
      {
        ...
        data: {
          items: [
            { id: 1, title: "Toptex / Winnertex", category: "Corporate", featured: true, description: "The gold standard for executive corporate shirting. A proprietary blend designed for crisp aesthetics and all-day comfort.", image: "https://res.cloudinary.com/detwuzqry/image/upload/v1776588262/stitcheerr_assets/acj0i3umdqo3qlaqp94h.jpg", colors: ["#1e3a8a", "#0f172a", "#f8fafc"] },
            { id: 2, title: "Nichiee Blend", category: "Uniforms", featured: false, description: "Optimized for high-stress professional uniforms. Wrinkle-resistant and highly durable 65% Poly / 35% Cotton blend.", image: "https://res.cloudinary.com/detwuzqry/image/upload/v1776588261/stitcheerr_assets/xptmbrbgmfj3xozpbhwu.jpg", colors: ["#334155", "#64748b"] },
            { id: 3, title: "Hospitality Elite", category: "Hospitality", featured: true, description: "Specialized fabrics for the hotel industry, including chef coats and housekeeping uniforms.", image: "https://res.cloudinary.com/detwuzqry/image/upload/v1776586858/stitcheerr_assets/r6sxvktceybqwkua4mxs.jpg", colors: ["#000000", "#ffffff"] },
            { id: 4, title: "Industrial Strength", category: "Industrial", featured: false, description: "Heavy-duty industrial grade material for factory and field wear. High tensile strength and abrasion resistant.", image: "https://res.cloudinary.com/detwuzqry/image/upload/v1776588263/stitcheerr_assets/dn3nvegkp9tv6n3thv73.jpg", colors: ["#713f12", "#ca8a04"] },
            { id: 5, title: "Medical Tech", category: "Medical", featured: true, description: "Antimicrobial and bleach-resistant fabric for healthcare professionals.", image: "https://res.cloudinary.com/detwuzqry/image/upload/v1776588264/stitcheerr_assets/k6a6rkvbndb2vqn6rfcx.jpg", colors: ["#e0e7ff", "#bfdbfe"] },
            { id: 6, title: "Security Rugged", category: "Security", featured: true, description: "Rugged and professional fabrics for private security, guards, and law enforcement uniforms.", image: "https://res.cloudinary.com/detwuzqry/image/upload/v1776587152/stitcheerr_assets/ewgoqvnm2ce0navpana8.jpg", colors: ["#000000", "#1e293b"] }
          ]
        }
      },
      {
